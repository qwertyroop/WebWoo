...
export const MacbookScroll = ({
  ...
  return (
    <div
      ref={ref}
      className="min-h-[200vh]  flex flex-col items-center py-0 md:py-0 justify-start flex-shrink-0 [perspective:800px] transform md:scale-100  scale-[0.35] sm:scale-50"
    >
      <motion.h2
        style={{
  ...
  return (
    <div className="relative [perspective:800px]">
      ...
      >
        ...
        <Image
          src={'https://ik.imagekit.io/t6luarqrmc/webwoo/banner.png'}
          alt="aceternity logo"
          fill
